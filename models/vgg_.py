...
model_paths = {
    'vgg16_bn': '/home/ubuntu/P2PNet_/apdcephfs/private_changanwang/checkpoints/vgg16_bn-6c64b313.pth',
    'vgg16': '/home/ubuntu/P2PNet_/apdcephfs/private_changanwang/checkpoints/vgg16-397923af.pth',
    'vgg19_bn': '/home/ubuntu/P2PNet_/apdcephfs/private_changanwang/checkpoints/vgg19_bn-c79401a0.pth',
}
...
def make_layers(cfg, batch_norm=True, sync=True):
    layers = []
    in_channels = 3
    for v in cfg:
        if v == 'M':
